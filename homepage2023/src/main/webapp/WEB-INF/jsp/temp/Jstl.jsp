	...
	<ul>
		<c:choose>
			...
			<c:when test="${step eq '4'}">
				<li>
					<h3>c:if Tag : 조건문 중의 하나. JAVA에서 사용하는 If와 통일</h3>
			...
			<li>
				<h3>c:forEach Tag : 기본 반복 태그, 고정 된 횟수 또는 초과 수집 동안 중첩 된 본문 내용을 반본</h3>
				<h4>기본문법 : <br/>
			...
			<c:when test="${step eq '10'}">
				<li>
					<h3>fn:indexOf() : 주어진 문자열이 특정 문자열로 시작하는 지 확인하는데 사용</h3>
			...
			<c:when test="${step eq '11'}">
				<li>
					<h3>fn:stratWith(); : 주어진 문자열이 특정 문자열 값으로 시작되는지 확인하는 데 사용</h3>
			...
			<li>
				<h3>fn:toUpperCase() : 문자열의 모든 문자를 대문자로 변한</h3>
